...
# mark_description "-masm=intel -O2 -mconditional-branch=all-fix -S -c -o ../target/intel/access/lfence.o2.asm";
...
..B1.2:                         # Preds ..B1.1
        ...
        movzx     edi, BYTE PTR [array1+rdi]                    #13.33
        shl       rdi, 9                                        #13.45
        mov       dl, BYTE PTR temp[rip]                        #13.11
        lfence                                                  #13.33
        movzx     eax, BYTE PTR [array2+rdi]                    #13.26
        shl       rax, 9                                        #13.52
        and       dl, BYTE PTR [array3+rax]                     #13.11
        mov       BYTE PTR temp[rip], dl                        #13.11
