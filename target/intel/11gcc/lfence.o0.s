...
# mark_description "-O0 -mconditional-branch=all-fix -S -c -o ../target/intel/11gcc/lfence.o0.s";
	.file "11gcc.c"
	.text
..TXTST0:
...
..L12:
	...
	.cfi_offset 6, -16
        subq      $64, %rsp                                     #21.60
        movq      %rdi, -48(%rbp)                               #21.60
        movq      %rsi, -40(%rbp)                               #21.60
        movq      %rdx, -32(%rbp)                               #21.60
        movq      -48(%rbp), %rax                               #22.60
        movq      %rax, -24(%rbp)                               #22.36
        movq      -40(%rbp), %rax                               #23.60
        movq      %rax, -16(%rbp)                               #23.36
                                # LOE rbx rbp rsp r12 r13 r14 r15 rip
..B2.11:                        # Preds ..B2.3
                                # Execution count [0.00e+00]
..B2.2:                         # Preds ..B2.11 ..B2.1
                                # Execution count [0.00e+00]
        movq      -32(%rbp), %rax                               #25.10
        movq      %rax, -8(%rbp)                                #25.10
        movq      $-1, %rax                                     #25.10
        addq      -32(%rbp), %rax                               #25.10
        movq      %rax, -32(%rbp)                               #25.10
        movq      -8(%rbp), %rax                                #25.10
        testq     %rax, %rax                                    #25.20
...
..B2.3:                         # Preds ..B2.2
        ...
        lfence                                                  #27.12
        movzbl    %al, %eax                                     #27.12
        movl      %eax, -64(%rbp)                               #27.12
        movq      -16(%rbp), %rax                               #27.21
        movzbl    (%rax), %eax                                  #27.21
        movzbl    %al, %eax                                     #27.21
        movl      %eax, -60(%rbp)                               #27.21
        movl      $1, %eax                                      #27.21
        addq      -16(%rbp), %rax                               #27.21
        movq      %rax, -16(%rbp)                               #27.21
        movl      $1, %eax                                      #27.12
        addq      -24(%rbp), %rax                               #27.12
        movq      %rax, -24(%rbp)                               #27.12
        movl      -64(%rbp), %eax                               #27.12
        movl      -60(%rbp), %edx                               #27.21
        cmpl      %edx, %eax                                    #27.21
...
..B2.4:                         # Preds ..B2.3
                                # Execution count [0.00e+00]
        movq      $-1, %rax                                     #28.20
        addq      -24(%rbp), %rax                               #28.11
        movzbl    (%rax), %eax                                  #28.11
        lfence                                                  #28.11
        movzbl    %al, %eax                                     #28.11
        movq      $-1, %rdx                                     #28.20
        addq      -16(%rbp), %rdx                               #28.20
        movzbl    (%rdx), %edx                                  #28.20
        movzbl    %dl, %edx                                     #28.20
        cmpl      %edx, %eax                                    #28.20
