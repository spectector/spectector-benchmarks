...
# mark_description "-masm=intel -O2 -mconditional-branch=all-fix -S -c -o ../target/intel/06/lfence.o2.asm";
...
..B1.2:                         # Preds ..B1.1
        ...
        movzx     edi, BYTE PTR [array1+rdi]                    #13.26
        shl       rdi, 9                                        #13.38
        mov       al, BYTE PTR temp[rip]                        #13.11
        lfence                                                  #13.26
        and       al, BYTE PTR [array2+rdi]                     #13.11
