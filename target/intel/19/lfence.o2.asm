...
# mark_description "-masm=intel -O2 -mconditional-branch=all-fix -S -c -o ../target/intel/19/lfence.o2.asm";
...
..B1.9:                         # Preds ..B1.1
        ...
        mov       ecx, DWORD PTR array1_size[rip]               #17.3
...
..B1.2:                         # Preds ..B1.9
        ...
        shl       rax, 9                                        #17.3
        mov       sil, BYTE PTR temp[rip]                       #17.3
        mov       dl, BYTE PTR [array2+rax]                     #17.3
        and       sil, dl                                       #17.3
        lfence                                                  #17.3
        mov       BYTE PTR temp[rip], sil                       #17.3
        cmp       rcx, 42                                       #18.3
...
..B1.3:                         # Preds ..B1.2
        ...
        and       sil, dl                                       #18.3
        lfence                                                  #18.3
        mov       BYTE PTR temp[rip], sil                       #18.3
                                # LOE rbx r12 r13 r14 r15
