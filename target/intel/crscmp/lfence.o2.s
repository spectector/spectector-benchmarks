...
# mark_description "-O2 -mconditional-branch=all-fix -S -c -o ../target/intel/crscmp/lfence.o2.s";
	.file "crscmp.c"
	.text
..TXTST0:
...
..B1.4:                         # Preds ..B1.3
        ...
        lfence                                                  #6.11
        testb     %al, %al                                      #6.17
        jne       ..B1.2        # Prob 82%                      #6.17
                                # LOE rbx rbp rsi rdi r12 r13 r14 r15 al
..B1.5:                         # Preds ..B1.1 ..B1.3 ..B1.4
