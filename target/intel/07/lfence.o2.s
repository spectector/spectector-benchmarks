...
# mark_description "-O2 -mconditional-branch=all-fix -S -c -o ../target/intel/07/lfence.o2.s";
	.file "07.c"
	.text
..TXTST0:
...
..B1.2:                         # Preds ..B1.1
        ...
        movzbl    array1(%rdi), %eax                            #13.26
        shlq      $9, %rax                                      #13.38
        movb      temp(%rip), %dl                               #13.11
        lfence                                                  #13.26
        andb      array2(%rax), %dl                             #13.11
        movb      %dl, temp(%rip)                               #13.11
                                # LOE rbx rbp rdi r12 r13 r14 r15
..B1.3:                         # Preds ..B1.1 ..B1.2
                                # Execution count [1.00e+00]
        movl      array1_size(%rip), %eax                       #14.14
        cmpq      %rax, %rdi                                    #14.14
