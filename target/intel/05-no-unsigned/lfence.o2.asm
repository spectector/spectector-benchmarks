...
# mark_description "-masm=intel -O2 -mconditional-branch=all-fix -S -c -o ../target/intel/05-no-unsigned/lfence.o2.asm";
...
..B1.6:                         # Preds ..B1.14 ..B1.5
        ...
        and       r9b, BYTE PTR [array2+r11]                    #25.7
        cmp       r8d, ecx                                      #24.5
        jae       ..B1.7        # Prob 35%                      #24.5
                                # LOE rax rbx rbp rdi r12 r13 r14 r15 edx ecx esi r8d r9b
..B1.14:                        # Preds ..B1.6
                                # Execution count [7.31e-01]
        lfence                                                  #21.34
        jmp       ..B1.6        # Prob 100%                     #21.34
                                # LOE rax rbx rbp rdi r12 r13 r14 r15 edx ecx esi r8d r9b
..B1.7:                         # Preds ..B1.6
                                # Execution count [4.11e-01]
