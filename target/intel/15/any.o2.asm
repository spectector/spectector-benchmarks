...
# mark_description "-masm=intel -O2 -S -c -o ../target/intel/15/any.o2.asm";
...
..B1.2:                         # Preds ..B1.1
        ...
        movzx     eax, BYTE PTR [array1+rdx]                    #12.20
        shl       rax, 9                                        #12.33
        mov       dl, BYTE PTR [array2+rax]                     #12.13
        and       BYTE PTR temp[rip], dl                        #12.5
