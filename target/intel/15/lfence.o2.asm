...
# mark_description "-masm=intel -O2 -mconditional-branch=all-fix -S -c -o ../target/intel/15/lfence.o2.asm";
...
..L2:
                                                          #10.37
        mov       rdx, QWORD PTR [rdi]                          #11.8
        lfence                                                  #11.8
        mov       eax, DWORD PTR array1_size[rip]               #11.12
        cmp       rdx, rax                                      #11.12
        jae       ..B1.3        # Prob 50%                      #11.12
                                # LOE rdx rbx rbp r12 r13 r14 r15
..B1.2:                         # Preds ..B1.1
                                # Execution count [5.00e-01]
        movzx     edx, BYTE PTR [array1+rdx]                    #12.20
        shl       rdx, 9                                        #12.33
        mov       al, BYTE PTR temp[rip]                        #12.5
        lfence                                                  #12.20
        and       al, BYTE PTR [array2+rdx]                     #12.5
