...
# mark_description "-masm=intel -O2 -mconditional-branch=all-fix -S -c -o ../target/intel/02/lfence.o2.asm";
...
..B2.2:                         # Preds ..B2.1
        ...
        movzx     edi, BYTE PTR [array1+rdi]                    #13.30
        shl       rdi, 9                                        #13.8
        mov       al, BYTE PTR temp[rip]                        #13.8
        lfence                                                  #13.30
        and       al, BYTE PTR [array2+rdi]                     #13.8
        mov       BYTE PTR temp[rip], al                        #13.8
