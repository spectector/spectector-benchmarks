...
# mark_description "-masm=intel -O2 -mconditional-branch=all-fix -S -c -o ../target/intel/20/lfence.o2.asm";
...
..B1.2:                         # Preds ..B1.1
        ...
        movzx     edi, BYTE PTR [array1+rdi]                    #11.15
        shl       rdi, 9                                        #13.24
        mov       al, BYTE PTR temp[rip]                        #13.5
        lfence                                                  #11.15
        and       al, BYTE PTR [array2+rdi]                     #13.5
