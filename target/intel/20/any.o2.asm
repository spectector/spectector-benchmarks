...
# mark_description "-masm=intel -O2 -S -c -o ../target/intel/20/any.o2.asm";
...
..B1.2:                         # Preds ..B1.1
        ...
        movzx     eax, BYTE PTR [array1+rdi]                    #11.15
        shl       rax, 9                                        #13.24
        mov       dl, BYTE PTR [array2+rax]                     #13.13
        and       BYTE PTR temp[rip], dl                        #13.5
