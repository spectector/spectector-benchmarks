...
# mark_description "-O2 -mconditional-branch=all-fix -S -c -o ../target/intel/10/lfence.o2.s";
	.file "10.c"
	.text
..TXTST0:
...
..B1.3:                         # Preds ..B1.2
        ...
        movb      array2(%rip), %al                             #13.24
        andb      %al, temp(%rip)                               #13.16
                                # LOE rbx rbp r12 r13 r14 r15
