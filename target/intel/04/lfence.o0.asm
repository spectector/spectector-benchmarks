...
# mark_description "-masm=intel -O0 -mconditional-branch=all-fix -S -c -o ../target/intel/04/lfence.o0.asm";
...
..L2:
	...
	.cfi_offset 6, -16
        ...
        cmp       rax, rdx                                      #11.11
        jae       ..B1.6        # Prob 50%                      #11.11
                                # LOE rbx rbp rsp r12 r13 r14 r15 rip
..B1.2:                         # Preds ..B1.1
                                # Execution count [0.00e+00]
        movzx     eax, BYTE PTR temp[rip]                       #12.5
        movzx     eax, al                                       #12.5
        mov       rdx, QWORD PTR [-16+rbp]                      #12.27
        shl       rdx, 1                                        #12.32
