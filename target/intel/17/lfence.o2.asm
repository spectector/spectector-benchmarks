...
# mark_description "-masm=intel -O2 -mconditional-branch=all-fix -S -c -o ../target/intel/17/lfence.o2.asm";
...
..L2:
                                                          #10.36
        movzx     edx, BYTE PTR [array1+rdi]                    #11.7
        lfence                                                  #11.7
        mov       eax, DWORD PTR array1_size[rip]               #11.19
        cmp       rdx, rax                                      #11.19
...
..B1.2:                         # Preds ..B1.1
        ...
        mov       dl, BYTE PTR [array2+rdx]                     #12.13
        and       al, dl                                        #12.5
        lfence                                                  #12.13
