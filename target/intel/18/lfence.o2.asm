...
# mark_description "-masm=intel -O2 -mconditional-branch=all-fix -S -c -o ../target/intel/18/lfence.o2.asm";
...
..B1.2:                         # Preds ..B1.1
        ...
        movzx     edx, BYTE PTR [array1+rdx]                    #13.26
        mov       al, BYTE PTR temp[rip]                        #13.11
        lfence                                                  #13.26
        and       al, BYTE PTR [array2+rdx]                     #13.11
