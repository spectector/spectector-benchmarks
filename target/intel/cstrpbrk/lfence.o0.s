...
# mark_description "-O0 -mconditional-branch=all-fix -S -c -o ../target/intel/cstrpbrk/lfence.o0.s";
	.file "cstrpbrk.c"
	.text
..TXTST0:
...
..L2:
	...
	.cfi_offset 6, -16
        subq      $48, %rsp                                     #1.49
        lfence                                                  #1.49
        movq      %rdi, -40(%rbp)                               #1.49
        movq      %rsi, -32(%rbp)                               #1.49
...
..B1.8:                         # Preds ..B1.6 ..B1.5
        ...
        cmpl      %edx, %eax                                    #10.15
        je        ..B1.3        # Prob 50%                      #10.15
                                # LOE rbx rbp rsp r12 r13 r14 r15 rip
..B1.9:                         # Preds ..B1.8
                                # Execution count [0.00e+00]
        movq      -24(%rbp), %rax                               #11.22
        leave                                                   #11.22
	.cfi_restore 6
        ret                                                     #11.22
	.cfi_offset 6, -16
