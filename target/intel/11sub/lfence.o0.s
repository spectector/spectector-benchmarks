...
# mark_description "-O0 -mconditional-branch=all-fix -S -c -o ../target/intel/11sub/lfence.o0.s";
	.file "11sub.c"
	.text
..TXTST0:
...
..L12:
	...
	.cfi_offset 6, -16
        subq      $48, %rsp                                     #20.60
        movq      %rdi, -48(%rbp)                               #20.60
        movq      %rsi, -40(%rbp)                               #20.60
        movq      %rdx, -32(%rbp)                               #20.60
        movq      -48(%rbp), %rax                               #21.60
        movq      %rax, -24(%rbp)                               #21.36
        movq      -40(%rbp), %rax                               #22.60
        movq      %rax, -16(%rbp)                               #22.36
        movq      -32(%rbp), %rax                               #23.7
        testq     %rax, %rax                                    #23.7
        jne       ..B2.9        # Prob 50%                      #23.7
                                # LOE rbx rbp rsp r12 r13 r14 r15 rip
..B2.2:                         # Preds ..B2.1
                                # Execution count [0.00e+00]
        movl      $0, %eax                                      #23.21
...
..B2.9:                         # Preds ..B2.1
                                # Execution count [0.00e+00]
..B2.3:                         # Preds ..B2.9 ..B2.5
                                # Execution count [0.00e+00]
        movq      $-1, %rax                                     #24.12
        addq      -32(%rbp), %rax                               #24.12
        movq      %rax, -8(%rbp)                                #24.12
        movq      -8(%rbp), %rax                                #24.12
        movq      %rax, -32(%rbp)                               #24.12
        movq      -8(%rbp), %rax                                #24.12
        testq     %rax, %rax                                    #24.12
...
..B2.4:                         # Preds ..B2.3
                                # Execution count [0.00e+00]
        movq      -24(%rbp), %rax                               #24.22
        movzbl    (%rax), %eax                                  #24.22
        lfence                                                  #24.22
        movzbl    %al, %eax                                     #24.22
        movq      -16(%rbp), %rdx                               #24.29
        movzbl    (%rdx), %edx                                  #24.29
        movzbl    %dl, %edx                                     #24.29
        cmpl      %edx, %eax                                    #24.29
...
..B2.5:                         # Preds ..B2.4
                                # Execution count [0.00e+00]
        movl      $1, %eax                                      #25.5
        addq      -24(%rbp), %rax                               #25.5
        movq      %rax, -24(%rbp)                               #25.5
        movl      $1, %eax                                      #26.5
        addq      -16(%rbp), %rax                               #26.5
        movq      %rax, -16(%rbp)                               #26.5
        jmp       ..B2.3        # Prob 100%                     #26.5
                                # LOE rbx rbp rsp r12 r13 r14 r15 rip
..B2.6:                         # Preds ..B2.4 ..B2.3
                                # Execution count [0.00e+00]
        movq      -24(%rbp), %rax                               #28.12
        movzbl    (%rax), %eax                                  #28.12
        lfence                                                  #28.12
        movzbl    %al, %eax                                     #28.12
        movq      -16(%rbp), %rdx                               #28.16
        movzbl    (%rdx), %edx                                  #28.16
        movzbl    %dl, %edx                                     #28.16
        negl      %edx                                          #28.16
        addl      %edx, %eax                                    #28.16
        leave                                                   #28.16
