...
# mark_description "-masm=intel -O2 -mconditional-branch=all-fix -S -c -o ../target/intel/11sub/lfence.o2.asm";
...
..B2.4:                         # Preds ..B2.3
        ...
        movzx     eax, BYTE PTR [rdi]                           #24.22
        movzx     edx, BYTE PTR [rsi]                           #24.29
        cmp       eax, edx                                      #24.29
...
..B2.5:                         # Preds ..B2.4
        ...
        inc       rsi                                           #26.5
        dec       rcx                                           #24.12
        jne       ..B2.3        # Prob 82%                      #24.12
                                # LOE rcx rbx rbp rsi rdi r12 r13 r14 r15
..B2.6:                         # Preds ..B2.2 ..B2.5
                                # Execution count [3.04e-01]
        movzx     eax, BYTE PTR [rdi]                           #28.12
        lfence                                                  #28.12
        movzx     edx, BYTE PTR [rsi]                           #28.16
