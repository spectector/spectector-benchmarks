...
# mark_description "-masm=intel -O2 -mconditional-branch=all-fix -S -c -o ../target/intel/03/lfence.o2.asm";
...
..L5:
        ...
        movzx     eax, dil                                      #13.77
        shl       rax, 9                                        #13.89
        mov       cl, BYTE PTR temp[rip]                        #13.69
        mov       dl, BYTE PTR [array2+rax]                     #13.77
        and       cl, dl                                        #13.69
        lfence                                                  #13.77
        mov       BYTE PTR temp[rip], cl                        #13.69
        ret                                                     #13.95
        .align    16,0x90
                                # LOE
	.cfi_endproc
