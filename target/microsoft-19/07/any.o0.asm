...
_TEXT	SEGMENT
x$ = 8
victim_function_v07 PROC
; File C:\Users\bokoepf\Research\Speculation\benchmarks\sources\microsoft\07.c
; Line 10
	mov	QWORD PTR [rsp+8], rcx
; Line 12
	mov	rax, QWORD PTR ?last_x@?1??victim_function_v07@@9@9
...
; Line 15
	...
	mov	QWORD PTR ?last_x@?1??victim_function_v07@@9@9, rax
$LN3@victim_fun:
; Line 16
	ret	0
