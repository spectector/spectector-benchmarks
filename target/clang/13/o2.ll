; ModuleID = '../sources/clang/13.c'
source_filename = "../sources/clang/13.c"
...
; Function Attrs: alwaysinline norecurse nounwind readonly sspstrong uwtable
define dso_local i32 @is_x_safe(i64) local_unnamed_addr #0 {
...
define dso_local void @victim_function_v13(i64) local_unnamed_addr #1 {
  %2 = load i32, i32* @array1_size, align 4, !tbaa !4
  %3 = zext i32 %2 to i64
  %4 = icmp ugt i64 %3, %0
...
attributes #0 = { alwaysinline norecurse nounwind readonly sspstrong uwtable "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "no-frame-pointer-elim"="false" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
