...
define dso_local void @leakByteNoinlineFunction(i8 zeroext) local_unnamed_addr #0 {
  %2 = zext i8 %0 to i64
...
define dso_local void @victim_function_v03(i64) local_unnamed_addr #1 {
...
; <label>:5:                                      ; preds = %1
  ...
  tail call void @leakByteNoinlineFunction(i8 zeroext %7)
  br label %8
